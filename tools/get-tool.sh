...
if [ ! -f "binutils-2.42.tar.xz" ]; then
    curl https://ftp.gnu.org/gnu/binutils/binutils-2.42.tar.xz -o binutils-2.42.tar.xz
fi
if [ ! -f "gdb-14.2.tar.xz" ]; then
    curl https://ftp.gnu.org/gnu/gdb/gdb-14.2.tar.xz -o gdb-14.2.tar.xz
fi
if [ ! -f "gcc-14.1.0.tar.xz" ]; then
    curl https://ftp.gnu.org/gnu/gcc/gcc-14.1.0/gcc-14.1.0.tar.xz -o gcc-14.1.0.tar.xz
fi
